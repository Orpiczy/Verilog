...
begin
  ...
  rgbfile = $fopen("D:/Dokumenty/AiR_rok_3/S6/Systemy_rekonfigurowalne/Konwersja_RGB_YCbCr/hand_64.ppm","rb");
//  rgbfile = $fopen({"D:/Dokumenty/AiR_rok_3/S6/Systemy_rekonfigurowalne/Wyznaczanie_srodka_ciezkosci/test_file/ppm/in_",frame[5:0]/10+8'h30,frame[5:0]%10+8'h30,".ppm"},"rb");
////  $fopen({"out_",vsc[5:0]/10+8'h30,vsc[5:0]%10+8'h30,".ppm"},"wb");
//  frame = (frame+1)%11;
////  rgbfile = $fopen({"D:/Dokumenty/AiR_rok_3/S6/Systemy_rekonfigurowalne/Wyznaczanie_srodka_ciezkosci/test_file/ppm/",vsc[7:0]/10+8'h30,".ppm"},"rb");
    //    rgbfile = $fopen("D:/Dokumenty/AiR_rok_3/S6/Systemy_rekonfigurowalne/Tor_wizyjny/hdmi_vga_zybo_src/hdmi_vga_zybo_src/geirangerfjord_64.ppm","rb");
